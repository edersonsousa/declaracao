...
estado_civil_combo.bind("<KeyRelease>", lambda event: on_select_estado_civil(event, nome_entry, rg_entry, cpf_entry, ato_combo, statusbar_text, estado_civil_combo))
estado_civil_combo.bind("<FocusOut>", lambda event: on_select_estado_civil(event, nome_entry, rg_entry, cpf_entry, ato_combo, statusbar_text, estado_civil_combo))
estado_civil_combo.bind("<Tab>", lambda event: on_select_estado_civil(event, nome_entry, rg_entry, cpf_entry, ato_combo, statusbar_text, estado_civil_combo))
